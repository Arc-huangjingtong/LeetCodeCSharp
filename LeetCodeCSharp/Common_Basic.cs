...
//1.  int.Max =  21_4748_3647 ≈  2*10^9
//2.  int.Min = -21_4748_3648 ≈ -2*10^9
//3. uint.Max =  42_9496_7295 ≈  4*10^9
//4. long.Max =  92_23_3372_0368_5477_5807 ≈  9*10^18
...
{
    /// <summary> 获取一个int值的幂和数组 </summary>
    /// <remarks> 幂和数组 : 即[包含最少数目的2的幂,且它们的和为n]的数组 </remarks>
    [TestCase(12, ExpectedResult = new[] { 4, 8 })]
    public static IList<int> GetPowers(int n)
    {
        // 1. 申明一个不定长的容器
        ...
        {
            // n & -n 是一种常见的位运算技巧，
            // 用于: [提取整数n的二进制表示中最右边的1所对应的值]
            // 具体来说，它返回一个整数，该整数在二进制表示中只有最右边的 1 保持不变，其余位都为 0。
            // 假设 : 12 = 0b1 [1] 00
            //      -12 = 0b0 [1] 00 ---- 二进制补码
            // 12 & -12 = 0b0 [1] 00 ---- 获得最右边的1
            //          = 4
            ...
            //      12 = 0b1 [1] 00
            //  12 - 1 = 0b1 [0] 11
            // 12 & 12 = 0b1 [0] 00 ---- 保留最右边的1,相当于减去了最右边的1
            n &= n - 1;
        }
