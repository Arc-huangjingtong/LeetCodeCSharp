...
// 注意点就是区间的大小可以用排序字典来优化
// 边界问题也需要注意,例如2406题,尾端点需要加一
...
/// <summary> 2406. 将区间分为最少组数 算术评级: 5 第 310 场周赛 Q3-1713 </summary>
public class Solution_2406
{
    public int MinGroups(int[][] intervals)
    {
        ...
        foreach (var interval in intervals)
        {
            var index1 = interval[0];
            var index2 = interval[1] + 1;

            diff.TryAdd(index1, 0);
            diff.TryAdd(index2, 0);
...
/// <summary> 2381. 字母移位 II 算术评级: 5 第 85 场双周赛Q3-1793 </summary>
